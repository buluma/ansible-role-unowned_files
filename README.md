...
|------|------|-------|---------|-------|------|-------------|
|[![github](https://github.com/buluma/ansible-role-unowned_files/workflows/Ansible%20Molecule/badge.svg)](https://github.com/buluma/ansible-role-unowned_files/actions)|[![gitlab](https://gitlab.com/buluma/ansible-role-unowned_files/badges/master/pipeline.svg)](https://gitlab.com/buluma/ansible-role-unowned_files)|[![quality](https://img.shields.io/ansible/quality/)](https://galaxy.ansible.com/buluma/unowned_files)|[![downloads](https://img.shields.io/ansible/role/d/)](https://galaxy.ansible.com/buluma/unowned_files)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-unowned_files.svg)](https://github.com/buluma/ansible-role-unowned_files/releases/)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-unowned_files.svg)](https://github.com/buluma/ansible-role-unowned_files/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-unowned_files.svg)](https://github.com/buluma/ansible-role-unowned_files/pulls/)|
...
- pip packages listed in [requirements.txt](https://github.com/buluma/ansible-role-unowned_files/blob/main/requirements.txt).
